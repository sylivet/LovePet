...
(1, 1, '2021-05-20 08:18:08.000000', '2021-05-22', '2021-05-23', 3, 2, 1, 1),
...
(5, 5, '2021-06-10 15:31:16.000000', '2021-06-18', '2021-06-20', 4, 4, 4, 1),
(6, 6, '2021-06-16 00:00:59.000000', '2021-06-22', '2021-06-23', 5, 2, 0, 1),
(7, 1, '2021-06-12 02:01:54.000000', '2021-06-16', '2021-06-17', 1, 3, 1, 1),
...
(1, 'a111111@yahoo.com.tw', '小華', '1111', '王曉華', '台北市士林區承德路四段194巷10號6樓', '0923774956', 0, 0, 1, './img/back_index/h1.jpg'),
...
(4, '吸水墊', 699, 'img/mall/吸水墊699元@2x.png', '質感舒適，柔軟有彈性，用久也不會變形，在室溫30度C以下使用尤佳。吸水力強，毛孩沐浴後使用，快速吸收濕氣。可水洗重複使用， 省錢環保。可手洗或機洗。無棉絮、無螢光劑，可安心使用。 \r\n\r\n秋冬換季可摺疊收納，擦乾後存放置陰涼處，避免陽光曝曬或高溫處。貓、狗、兔，鳥，皆可使用。 ', 11, '用品', 1, 1, 'img/mall/water4@2x.png', 'img/mall/water1@2x.png', 'img/mall/water2@2x.png', 'img/mall/water3@2x.png'),
(5, '奧利反光寵物胸背帶', 699, 'img/mall/奧利反光寵物胸背帶699元@2x.png', '反光條胸背帶 夜間外出更安全。配色時尚、材質耐用、透氣舒適、讓狗狗穿戴舒服。 \r\n\r\n建議定期檢查安全帶強度，不與其他頸戴產品一起使用。安全扣環給寵物更多保護，使用時聽到安全扣環聲音即可，請勿過度緊繫。 ', 6, '用品', 1, 1, 'img/mall/belt4@2x.png', 'img/mall/belt1@2x.png', 'img/mall/belt2@2x.png', 'img/mall/belt3@2x.png'),
(6, '波浪斜坡寵物樓梯', 1590, 'img/mall/波浪斜坡寵物樓梯1590元@2x.png', '韓國斜坡寵物階梯，樓梯 高度36cm。高密度彈力泡棉，保護毛寶貝的膝蓋不受傷，也減少毛孩對高度的恐懼。安全穩定台階，比一般階梯更平穩，使毛孩有安全感。 \r\n\r\n布料表面附有止滑顆粒設計，防止行走時滑倒。可拆洗布套，清潔便利。高密度彈力泡棉如床墊般，同一部位長時間承受壓力會有凹陷產生，此為正常現象。 ', 9, '用品', 1, 1, 'img/mall/stairs4@2x.png', 'img/mall/stairs1@2x.png', 'img/mall/stairs2@2x.png', 'img/mall/stairs3@2x.png'),
(7, '糰子貓宅', 2490, 'img/mall/糰子貓宅2490元@2x.png', '糰子貓宅以台灣專利長纖維蠶絲材質技術結合穴居設計，為貓咪提供更多安全感，讓平常忙碌的貓奴能與貓皇享有更好的共居生活。 \r\n\r\n四季皆可用，2合1穴型貓居所，貓窩成型加入微弱貓草氣味，提高貓咪接受度。不只透氣，耐洗、耐烘，清潔更方便!顛覆你對貓窩的想像！ ', 44, '用品', 1, 1, 'img/mall/catsole4@2x.png', 'img/mall/catsole1@2x.png', 'img/mall/catsole2@2x.png', 'img/mall/catsole3@2x.png'),
(8, '寵物碗架組', 2250, 'img/mall/寵物碗架組2250元@2x.png', '特別對 柴犬、雪納瑞、喜樂蒂、巴吉度、蘇格蘭梗等等中型犬的身高設計，讓毛孩們都能輕鬆無壓力的選用，減低她們脊椎的負擔。 \r\n\r\n木架加上彈性止滑墊圈，防止毛孩們用餐時打翻、滑動，更添加一份使用的安全感。 \r\n\r\n食用碗選用頂級的白骨瓷，不易磨損及破裂，有適度的透光。利用曲木的工藝技巧，加上特殊卡縫設計，讓整體無螺絲也能輕鬆穩固。 ', 31, '用品', 1, 1, 'img/mall/dish4@2x.png', 'img/mall/dish1@2x.png', 'img/mall/dish2@2x.png', 'img/mall/dish3@2x.png'),
(9, '貓抓柱', 1690, 'img/mall/貓抓柱1690元@2x.png', '麻繩貓抓柱，可讓貓咪直立或水平的磨爪舒壓產品，簡約的造型亦可搭配空間傢俱，作貓踏板使用 ！ \r\n\r\n鎖牆式的貓抓柱，可當貓跳台&貓抓柱, 更加牢固且增加貓咪活動的趣味性。可依照貓咪體型調整高度，材質環保無毒，貓咪使用安全。 ', 1, '用品', 1, 1, 'img/mall/post4@2x.png', 'img/mall/post1@2x.png', 'img/mall/post2@2x.png', 'img/mall/post3@2x.png'),
(10, '鯊魚造型貓窩', 479, 'img/mall/鯊魚造型貓窩NT479@2x.png', '韓國設計、原裝進口，可愛鯊魚造型貓窩。現代時尚灰色，可百搭居家空間，打造喵星人溫款小窩。適用4kg以下貓咪。 \r\n\r\n能折疊收納，附上可分離式的坐墊，更方便清洗。建議手洗以免變形，勿長時間浸泡，以免褪色。 ', 6, '用品', 1, 1, 'img/mall/shark4@2x.png', 'img/mall/shark1@2x.png', 'img/mall/shark2@2x.png', 'img/mall/shark3@2x.png'),
(11, '黑六角椅墊組', 3350, 'img/mall/黑六角椅墊組3350元@2x.png', '地面凳型設計，既可以讓人乘坐休息的椅凳，也能拿下坐墊當小茶几桌使用！ \r\n\r\n椅墊使用高密度防貓抓布材質，既使調皮的貓抓也不必擔心！ \r\n\r\n可以依照環境，自由的排列組合成最適合玩耍的動線。材質是黑色烤漆松木、高密度海綿、耐抓沙發布、矽膠止滑墊，可耐重100kg。 ', 2, '用品', 1, 1, 'img/mall/six4@2x.png', 'img/mall/six1@2x.png', 'img/mall/six2@2x.png', 'img/mall/six3@2x.png'),
(12, '太空艙', 3600, 'img/mall/4@2x.png', '喵星人們玩累了，進入舒適的太空艙休息，享受著太空艙所帶來的包覆安全感，為下一波的探險活動補足精力及體力。 \r\n\r\n壁掛式的設計，配合家具(如衣櫃、書櫃等)，讓喵星人們，在家中有著更豐富的跳躍生活，更為家中平凡的壁面，增添生活趣味。 \r\n\r\n​材質為胡桃木以及壓克力，可耐重 15kg。 ', 0, '用品', 1, 1, 'img/mall/space4@2x.png', 'img/mall/space1@2x.png', 'img/mall/space2@2x.png', 'img/mall/space3@2x.png'),
